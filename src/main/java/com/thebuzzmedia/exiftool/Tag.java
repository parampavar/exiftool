...
/// A [Tag] is a value that can be easily extracted from images with
/// an external install of ExifTool.
///
/// A tag that can be easily parsed to a valid value
/// using the [#parse(String)] hint from each [Tag].
...
/// [com.thebuzzmedia.exiftool.core.StandardFormat#HUMAN_READABLE] format and
...
/// by Phil Harvey; the caller is free to parse or process the returned [String] values
/// any way they wish.
///
